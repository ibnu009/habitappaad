...
class HabitRepository(private val habitDao: HabitDao, private val executor: ExecutorService) {
    ...
    //TODO 4 : Use SortUtils.getSortedQuery to create sortable query and build paged list (DONE)
    fun getHabits(filter: HabitSortType): LiveData<PagedList<Habit>> {
        val habits = habitDao.getHabits(SortUtils.getSortedQuery(filter))
    ...
    //TODO 5 : Complete other function inside repository (DONE)
